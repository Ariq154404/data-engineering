...
with DAG(
    ...
    extract_result_for_jobs_task

# with DAG(
#     'initial_dag',
#     default_args=default_args,
#     description='A DAG to say hell',
#     schedule_interval=None,  # This DAG is manually triggered, not scheduled
#     start_date=datetime(2023, 9, 21),
#     catchup=False,
# ) as dag:
